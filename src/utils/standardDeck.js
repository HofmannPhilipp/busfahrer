const standardDeck = [
  ...
  { rank: 11, suit: "heart", src: "/hearts_jack.png" },
  { rank: 11, suit: "diamond", src: "/diamonds_jack.png" },
  { rank: 11, suit: "club", src: "/clubs_jack.png" },
  { rank: 11, suit: "spade", src: "/spades_jack.png" },

  { rank: 12, suit: "heart", src: "/hearts_queen.png" },
  { rank: 12, suit: "diamond", src: "/diamonds_queen.png" },
  { rank: 12, suit: "club", src: "/clubs_queen.png" },
  { rank: 12, suit: "spade", src: "/spades_queen.png" },

  { rank: 13, suit: "heart", src: "/hearts_king.png" },
  { rank: 13, suit: "diamond", src: "/diamonds_king.png" },
  { rank: 13, suit: "club", src: "/clubs_king.png" },
  { rank: 13, suit: "spade", src: "/spades_king.png" },

  { rank: 14, suit: "heart", src: "/hearts_ace.png" },
  { rank: 14, suit: "diamond", src: "/diamonds_ace.png" },
  { rank: 14, suit: "club", src: "/clubs_ace.png" },
  { rank: 14, suit: "spade", src: "/spades_ace.png" },
];
